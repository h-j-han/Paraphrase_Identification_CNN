...
Training script for semantic relatedness prediction on the SICK dataset.
  ...
  -t,--task   (default quo)       TaskD vid2 for msrvid2 and quo for QUORA msp for MSRP
  -r,--thread (default 1)          number of torch.setnumthreads( )
  -o,--option (default test)      train or test or dev option
  -x,--loadDir (default quomodel.epoch10.devscore0.636)  Loaded model for testing
