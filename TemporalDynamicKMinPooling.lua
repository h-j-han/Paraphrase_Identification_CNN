...
local TemporalDynamicKMinPooling, parent = torch.class('nn.TemporalDynamicKMinPooling', 'nn.Module')

function TemporalDynamicKMinPooling:__init(minK, factor)
   parent.__init(self)
...
function TemporalDynamicKMinPooling:updateOutput(input)
   ...
   local sorted, allIndices = input:sort(seqDim)
...
function TemporalDynamicKMinPooling:updateGradInput(input, gradOutput)
...
function TemporalDynamicKMinPooling:clearState()
